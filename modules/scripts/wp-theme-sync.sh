...
if [ -f "$PREVIEW_PATH_1" ]; then
    ...
    if ! cmp -s /home/elliot/.config/matugen/templates/colors_new.qml /home/elliot/nixos/modules/quickshell/shell/Matugen.qml; then \
            mv /home/elliot/.config/matugen/templates/colors_new.qml /home/elliot/nixos/modules/quickshell/shell/Matugen.qml && exit 0; \
            else \
            exit 1; \
            fi
